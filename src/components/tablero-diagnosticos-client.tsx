...
const getMunicipioIcon = (municipio: string): string => {
  ...
  const municipioMap: { [key: string]: string } = {
    ...
    'zacualpandeamilpas': 'zacualpan.gif' // Zacualpan de Amilpas
  }
...
export default function TableroDiagnosticosClient({
  ...
  const AccionesExpandidas = ({ diagnostico }: { diagnostico: DiagnosticoMunicipal }) => {
    ...
    const hasPDFs = diagnostico.solicitudUrl || diagnostico.respuestaUrl || diagnostico.diagnosticoUrl
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Documento de diagnóstico municipal</p>
                          </div>
                        </div>
                        <a
                          href={diagnostico.diagnosticoUrl}
                          target="_blank"
