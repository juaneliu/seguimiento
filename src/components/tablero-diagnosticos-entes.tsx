...
const TableroDiagnosticosEntesClient = dynamic(() => import('./tablero-diagnosticos-entes-client'), {
  ssr: false,
  loading: () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg p-8">
        <h1 className="text-3xl font-bold">Diagnósticos de Entes</h1>
...
export function TableroDiagnosticosEntes(props: TableroDiagnosticosEntesProps) {
  return <TableroDiagnosticosEntesClient {...props} />
}
