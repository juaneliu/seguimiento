...
const ENTES_PUBLICOS_MORELOS = [
  ...
  "Titular del Tribunal de Justicia Administrativa del Estado de Morelos",
  "Titular del Tribunal Electoral del Estado de Morelos",
  "Titular del Tribunal Unitario de Justicia Penal para Adolescentes del Estado de Morelos",
                      ...
                      <FormField
                        ...
                        render={({ field, fieldState }) => (
                          <FormItem className="form-container-fixed">
                            <FormLabel className="text-base font-semibold text-slate-700 dark:text-slate-200">
                              Ente Público <span className="text-red-500 font-bold text-lg ml-1">*</span>
                            </FormLabel>
                            <Select 
                              onValueChange={(value) => {
                    ...
                    <div className="form-grid-fixed">
                      ...
                      <FormField
                        ...
                        render={({ field, fieldState }) => (
                          <FormItem className="form-container-fixed">
                            <FormLabel className="text-base font-semibold text-slate-700 dark:text-slate-200">
                              Poder <span className="text-red-500 font-bold text-lg ml-1">*</span>
                            </FormLabel>
                            <Select 
                              onValueChange={(value) => {
                                field.onChange(value)
                      ...
                      <FormField
                        ...
                        render={({ field, fieldState }) => (
                          <FormItem className="form-container-fixed">
                            <FormLabel className="text-base font-semibold text-slate-700 dark:text-slate-200">
                              Órgano <span className="text-red-500 font-bold text-lg ml-1">*</span>
                            </FormLabel>
                            <Select 
                              onValueChange={(value) => {
                                field.onChange(value)
